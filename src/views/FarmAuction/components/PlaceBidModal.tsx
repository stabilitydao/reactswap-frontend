...
import { Modal, Text, Flex, BalanceInput, Box, Button, LogoRoundIcon } from '@reactswap/uikit'
...
const PlaceBidModal: React.FC<PlaceBidModalProps> = ({
  ...
  const { balance: userCake, fetchStatus } = useTokenBalance(tokens.react.address)
