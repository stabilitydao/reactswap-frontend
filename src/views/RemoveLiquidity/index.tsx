...
import { Currency, currencyEquals, ETHER, Percent, WETH } from '@reactswap/sdk'
import { Button, Text, AddIcon, ArrowDownIcon, CardBody, Slider, Box, Flex, useModal } from '@reactswap/uikit'
...
export default function RemoveLiquidity() {
  ...
  async function onAttemptToApprove() {
    ...
    const domain = {
      name: 'ReactSwap Liquidity Provider',
      version: '1',
      chainId,
