...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and React pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and React pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from React pool', data)
  }
