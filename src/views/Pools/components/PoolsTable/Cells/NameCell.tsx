...
import { Text, useMatchBreakpoints, TokenPairImage as UITokenPairImage } from '@reactswap/uikit'
...
const NameCell: React.FC<NameCellProps> = ({ pool }) => {
  ...
  if (vaultKey) {
    ...
    title = t('Manual REACT')
    subtitle = `${t('Earn')} REACT ${t('Stake').toLocaleLowerCase()} REACT`
  }
